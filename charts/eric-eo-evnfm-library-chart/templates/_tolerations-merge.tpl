...
*/}}
{{- define "eric-eo-evnfm-library-chart.merge-tolerations" -}}
  {{- if (.root.Values.global).tolerations }}
      ...
      {{- range $globalItem := $globalTolerations -}}
        {{- $globalItemId := include "eric-eo-evnfm-library-chart.merge-tolerations.get-identifier" $globalItem -}}
        {{- range $serviceItem := $serviceTolerations -}}
          {{- $serviceItemId := include "eric-eo-evnfm-library-chart.merge-tolerations.get-identifier" $serviceItem -}}
      ...
      {{- range $globalItem := $globalTolerations -}}
        ...
        {{- range $matchItem := $matchingItems -}}
          {{- $matchItemId := include "eric-eo-evnfm-library-chart.merge-tolerations.get-identifier" $matchItem -}}
...
*/}}
{{ define "eric-eo-evnfm-library-chart.merge-tolerations.get-identifier" }}
  {{- $keyValues := list -}}
