...
{{- define "eric-eo-evnfm-library-chart.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-eo-evnfm-library-chart.mergeAnnotations" -}}
  {{- include "eric-eo-evnfm-library-chart.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) | trim}}
{{- end -}}

{{- define "eric-eo-evnfm-library-chart.mergeLabels" -}}
  {{- include "eric-eo-evnfm-library-chart.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) | trim }}
{{- end -}}